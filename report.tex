...
\rhead{\emph{1D-2D Puzzle GCHQ}}

\fancyfoot[LO,LE]{\emph{Team W}}
\cfoot{}
...
\input{project/Revision-history.tex} % adds the Revision-history page
\input{project/introduction.tex} % adds the introduction page
\input{project/Project-Description.tex} % adds the Project-Description page
\input{project/Requirements.tex}% adds the Requirementsf page
